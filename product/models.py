...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Overrides the default `save` method to generate a
        unique slug based on the name and a UUID.

        If the slug is not provided, a new slug is generated by
        combining the slugified name and a UUID.
